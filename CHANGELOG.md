...
- Update software to check number of records specified in label matches the records in the table [\#216](https://github.com/NASA-PDS/validate/pull/216) ([hhlee445](https://github.com/hhlee445))
...
- Revert "Remove confusion about XML file filters" [\#213](https://github.com/NASA-PDS/validate/pull/213) ([jordanpadams](https://github.com/jordanpadams))
- Validate incorrectly fails for ASCII\_Integer value in Table\_Character [\#207](https://github.com/NASA-PDS/validate/pull/207) ([hhlee445](https://github.com/hhlee445))
- Fixed \#203, Assembly plugin non-fatal errors on Windows [\#205](https://github.com/NASA-PDS/validate/pull/205) ([tdddblog](https://github.com/tdddblog))
- Update schematron schematyphens pattern with whitespace check [\#202](https://github.com/NASA-PDS/validate/pull/202) ([jordanpadams](https://github.com/jordanpadams))
...
- Lessen restriciton on file/directory naming [\#200](https://github.com/NASA-PDS/validate/pull/200) ([jordanpadams](https://github.com/jordanpadams))
- Add report file path flag to validate-bundle [\#198](https://github.com/NASA-PDS/validate/pull/198) ([jordanpadams](https://github.com/jordanpadams))
- Update to Saxon v9.9.1-7 [\#193](https://github.com/NASA-PDS/validate/pull/193) ([jordanpadams](https://github.com/jordanpadams))
- Add validated product counter to pass/fail reporting and end summary [\#191](https://github.com/NASA-PDS/validate/pull/191) ([hhlee445](https://github.com/hhlee445))
...
- Validate Table\_Character groups and group\_lengths do not overlap [\#186](https://github.com/NASA-PDS/validate/pull/186) ([hhlee445](https://github.com/hhlee445))
- Implement validate-bundle script [\#184](https://github.com/NASA-PDS/validate/pull/184) ([galenatjpl](https://github.com/galenatjpl))
...
- Upgrade Saxon to help prevent memory leak [\#185](https://github.com/NASA-PDS/validate/pull/185) ([jordanpadams](https://github.com/jordanpadams))
...
- Fixes multi-threading and MD5 checksum generation bugs [\#181](https://github.com/NASA-PDS/validate/pull/181) ([jordanpadams](https://github.com/jordanpadams))
- issue\_63: Modify pom.xml to use latest pds4-jparser pkg [\#179](https://github.com/NASA-PDS/validate/pull/179) ([hhlee445](https://github.com/hhlee445))
- Revert back to Saxon 9.5.1-3 to avoid schematron bug [\#176](https://github.com/NASA-PDS/validate/pull/176) ([jordanpadams](https://github.com/jordanpadams))
...
- Fix bug introduced from \#149 fix [\#174](https://github.com/NASA-PDS/validate/pull/174) ([jordanpadams](https://github.com/jordanpadams))
...
- Update field value validator to allow empty fields [\#172](https://github.com/NASA-PDS/validate/pull/172) ([jordanpadams](https://github.com/jordanpadams))
- issue\_149: Update to check number of records specified in label and from the table [\#169](https://github.com/NASA-PDS/validate/pull/169) ([hhlee445](https://github.com/hhlee445))
- Fix spotCheckData bug for content validation of tables [\#166](https://github.com/NASA-PDS/validate/pull/166) ([jordanpadams](https://github.com/jordanpadams))
- Update pom to use PDS Parent POM [\#163](https://github.com/NASA-PDS/validate/pull/163) ([jordanpadams](https://github.com/jordanpadams))
- Update string comparison to use .equals\(\) [\#162](https://github.com/NASA-PDS/validate/pull/162) ([jordanpadams](https://github.com/jordanpadams))
- Update all timing metrics to only appear for DEBUG [\#161](https://github.com/NASA-PDS/validate/pull/161) ([jordanpadams](https://github.com/jordanpadams))
- issue\_56: Added error message when the definition of two fields in a … [\#159](https://github.com/NASA-PDS/validate/pull/159) ([hhlee445](https://github.com/hhlee445))
- issue\_156:  Performance Log Metrics and more [\#157](https://github.com/NASA-PDS/validate/pull/157) ([galenatjpl](https://github.com/galenatjpl))
- Issue 126 [\#154](https://github.com/NASA-PDS/validate/pull/154) ([hhlee445](https://github.com/hhlee445))
- Issue \#124: The tool shall average less than 1 second execution time when content validation is disabled [\#152](https://github.com/NASA-PDS/validate/pull/152) ([hhlee445](https://github.com/hhlee445))
...
- Added java.util.logging properties to suppress messages [\#151](https://github.com/NASA-PDS/validate/pull/151) ([jordanpadams](https://github.com/jordanpadams))
...
- Fix bug with parent LID integrity checking for collections [\#147](https://github.com/NASA-PDS/validate/pull/147) ([jordanpadams](https://github.com/jordanpadams))
...
- Updated parent LID check to include ':' [\#140](https://github.com/NASA-PDS/validate/pull/140) ([jordanpadams](https://github.com/jordanpadams))
...
- Update field validator to allow empty fields for delimited tables [\#138](https://github.com/NASA-PDS/validate/pull/138) ([jordanpadams](https://github.com/jordanpadams))
...
- Update context product config query to include all context products [\#136](https://github.com/NASA-PDS/validate/pull/136) ([jordanpadams](https://github.com/jordanpadams))
...
- Change --no-data-check flag to --skip-content-validation [\#134](https://github.com/NASA-PDS/validate/pull/134) ([jordanpadams](https://github.com/jordanpadams))
- Build 10a I&T bug fixes [\#122](https://github.com/NASA-PDS/validate/pull/122) ([jordanpadams](https://github.com/jordanpadams))
- Update schema resolution to use catalog resolver [\#115](https://github.com/NASA-PDS/validate/pull/115) ([jordanpadams](https://github.com/jordanpadams))
- Update launcher to allow config specification of schemas [\#112](https://github.com/NASA-PDS/validate/pull/112) ([jordanpadams](https://github.com/jordanpadams))
- Update context product check to allow multi-valued name/type [\#111](https://github.com/NASA-PDS/validate/pull/111) ([jordanpadams](https://github.com/jordanpadams))
- Issue \#42: Add capability to ignore product-level validation [\#109](https://github.com/NASA-PDS/validate/pull/109) ([jordanpadams](https://github.com/jordanpadams))
- Issue \#30: Performance Improvements [\#108](https://github.com/NASA-PDS/validate/pull/108) ([galenatjpl](https://github.com/galenatjpl))
- Update context\_ref\_mismatch rule to be WARNING instead of ERROR [\#104](https://github.com/NASA-PDS/validate/pull/104) ([jordanpadams](https://github.com/jordanpadams))
- Add new target-manifest flag for user to provide a manifest of file/directory paths [\#103](https://github.com/NASA-PDS/validate/pull/103) ([jordanpadams](https://github.com/jordanpadams))
- Add skip context validation to class [\#100](https://github.com/NASA-PDS/validate/pull/100) ([jordanpadams](https://github.com/jordanpadams))
- Add new Common Errors page to documentation [\#98](https://github.com/NASA-PDS/validate/pull/98) ([jordanpadams](https://github.com/jordanpadams))
- issue \#3: JAXB warning message with Java 9+ [\#95](https://github.com/NASA-PDS/validate/pull/95) ([danyu-pds](https://github.com/danyu-pds))
- issue \#20: Improve documentation about usage of flags in config file [\#94](https://github.com/NASA-PDS/validate/pull/94) ([danyu-pds](https://github.com/danyu-pds))
- \[\#47\] Add capability for disabling context reference validation [\#93](https://github.com/NASA-PDS/validate/pull/93) ([jordanpadams](https://github.com/jordanpadams))
- Issue 41: Added timing\_metrics.sh [\#92](https://github.com/NASA-PDS/validate/pull/92) ([galenatjpl](https://github.com/galenatjpl))
- Adds `data\_to\_investigation` context references [\#91](https://github.com/NASA-PDS/validate/pull/91) ([jordanpadams](https://github.com/jordanpadams))
- Fix for ASCII\_Integer should fail on space character [\#88](https://github.com/NASA-PDS/validate/pull/88) ([hhlee445](https://github.com/hhlee445))
- issue\_8: Fix for Uncaught Exception Error [\#83](https://github.com/NASA-PDS/validate/pull/83) ([hhlee445](https://github.com/hhlee445))
- Issue 15: Verify that all name/type attribute values correspond to  names denoted context products [\#82](https://github.com/NASA-PDS/validate/pull/82) ([danyu-pds](https://github.com/danyu-pds))
- Issue \#62: Include wider range of context products in validation [\#76](https://github.com/NASA-PDS/validate/pull/76) ([jordanpadams](https://github.com/jordanpadams))
...
- Issue \#74: Update tar/zip assemblies to ignore sources jars [\#75](https://github.com/NASA-PDS/validate/pull/75) ([jordanpadams](https://github.com/jordanpadams))
...
- Issue \#70 \#71 \#72: Update launcher and pom to better handle catalog files [\#73](https://github.com/NASA-PDS/validate/pull/73) ([jordanpadams](https://github.com/jordanpadams))
...
- Issue \#28: Integration tests for new feature checkout [\#61](https://github.com/NASA-PDS/validate/pull/61) ([jordanpadams](https://github.com/jordanpadams))
- Issue \#28: Add capability for user to input JSON file with additional context products [\#60](https://github.com/NASA-PDS/validate/pull/60) ([danyu-pds](https://github.com/danyu-pds))
- Issue \#23: Validate Tool - Deprecate -f and -m flags [\#59](https://github.com/NASA-PDS/validate/pull/59) ([hhlee445](https://github.com/hhlee445))
- Issue \#24: Retrieve and use latest context products from EN Registry [\#53](https://github.com/NASA-PDS/validate/pull/53) ([jordanpadams](https://github.com/jordanpadams))
- Issue \#33: Ignore resources with null systemId [\#49](https://github.com/NASA-PDS/validate/pull/49) ([jordanpadams](https://github.com/jordanpadams))
- Issue \#39: Fix memory leak on large bundles [\#36](https://github.com/NASA-PDS/validate/pull/36) ([galenatjpl](https://github.com/galenatjpl))
- Merging develop into master [\#35](https://github.com/NASA-PDS/validate/pull/35) ([jordanpadams](https://github.com/jordanpadams))
- Issue \#31: POM and README updates for Maven operational deployment [\#32](https://github.com/NASA-PDS/validate/pull/32) ([jordanpadams](https://github.com/jordanpadams))
- Issue \#26: Update build per pds4-tools rename and open source [\#27](https://github.com/NASA-PDS/validate/pull/27) ([jordanpadams](https://github.com/jordanpadams))
- Issue \#19: Add PDS Core library from PDSEN repo [\#25](https://github.com/NASA-PDS/validate/pull/25) ([jordanpadams](https://github.com/jordanpadams))
- Issue \#21: Update docs to reference public data [\#22](https://github.com/NASA-PDS/validate/pull/22) ([jordanpadams](https://github.com/jordanpadams))
