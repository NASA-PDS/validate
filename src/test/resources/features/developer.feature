...
# Field Special Constants
 ...
 |"NASA-PDS/validate#432 reference integrity check" | "github432" | 1 | "1 error messages expected." | "FIELD_VALUE_OUT_OF_MIN_MAX_RANGE" | "src/test/resources" | "target/test" | "-r {reportDir}/report_github432.json -s json -t {resourceDir}/github432/bundle-voyager1-pls-sat-1.0.xml" | "report_github432.json" |
