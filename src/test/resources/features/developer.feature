...
# Field Special Constants
 ...
 |"NASA-PDS/validate#432 reference integrity check" | "github432" | 1 | "1 warning messages expected." | "REFERENCE_NOT_FOUND" | "src/test/resources" | "target/test" | "-r {reportDir}/report_github432.json -s json -t {resourceDir}/github432/bundle-voyager1-pls-sat-1.0.xml" | "report_github432.json" |
