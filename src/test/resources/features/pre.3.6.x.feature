...
| 50 | 2 | "github50" | "--target-manifest {datasink}/target-manifest.xml -t {datasrc}/ele_evt_8hr_orbit_2014-2015.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.missing_file=1" |
