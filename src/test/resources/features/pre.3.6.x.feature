...
# https://github.com/NASA-PDS/validate/issues/217
 ...
 |"NASA-PDS/validate#217 FAIL1: Add Additional Tables Type Content Validation" | "github217" | 6 | "6 records mismatch errors expected" | "RECORDS_MISMATCH" | "src/test/resources" | "target/test" | "-r {reportDir}/report_github217_2.json  -s json -t {resourceDir}/github217/fail" | "report_github217_2.json" |
 |"NASA-PDS/validate#217 FAIL2: Add Additional Tables Type Content Validation" | "github217" | 9 | "9 table definition errors expected" | "TABLE_DEFINITION_PROBLEM" | "src/test/resources" | "target/test" | "-r {reportDir}/report_github217_3.json  -s json -t {resourceDir}/github217/fail" | "report_github217_3.json" |
