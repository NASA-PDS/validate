...
| 817 |  | "github681" | "-t {datasrc}/ff_char_fail.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.field_value_format_precision_mismatch=1" |
...
| 755 | 1 | "github755" | "-skip-context-validation -t {datasrc}/m221011.0013.xml {datasrc}/m221011.0014.xml {datasrc}/m221011.0015.xml {datasrc}/m221011.0030.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.file_areas_duplicated_reference=1" |
...
| 693 |  | "github693" | "-t {datasrc}/" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.pdf.file.not_pdfa_compliant=1" |
...
| 681 | 2 | "github681" | "-t {datasrc}/ff_char_fail.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.field_value_format_precision_mismatch=1" |
...
| 680 | 2 | "github680" | "--skip-context-validation -t {datasrc}/ORB12_EUR_EPHIO_reclen95.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.record_length_mismatch=1" |
...
| 628 |  | "github628" | "--skip-content-validation --disable-context-mismatch-warnings -t {datasrc}/mp2_flat_20061109.xml" | "summary:totalErrors=1,summary:totalWarnings=0" |
| 617 |  | "github617" | "--skip-content-validation -t {datasrc}/uvis_euv_2005_159_solar_time_series_ingress.xml" | "summary:totalErrors=1,summary:totalWarnings=0" |
...
| 535 | 2 | "github535" | "-t {datasrc}/uvis_euv_2016_288_solar_time_series_egress.xml --complete-descriptions" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.table_definition_problem=1" |
...
| 531 | 2 | "github531" | "--skip-context-validation -t {datasrc}/fail/b.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.table_definition_problem=1" |
...
| 499 | 2 | "github499" | "--skip-context-validation -t {datasrc}/fail/M7_217_044546_N.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.missing_CRLF=1" |
...
| 482 | 5 | "github482" | "--skip-context-validation -R pds4.folder -t {datasrc}/bundle1/" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.execution.no_products_found=1" |
| 482 | 6 | "github482" | "--skip-context-validation -R pds4.folder -e lblx -t {datasrc}/bundle2/" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.execution.no_products_found=1" |
| 480 | 1 | "github480" | "--skip-context-validation -t {datasrc}/test_success.xml --skip-content-validation" |  |
| 480 | 2 | "github480" | "-t {datasrc}/test_fail_header_offset.xml --skip-content-validation" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.invalid_object_definition=1" |
| 480 | 3 | "github480" | "-t {datasrc}/test_fail_table_offset.xml --skip-content-validation" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.invalid_object_definition=1" |
| 469 | 1 | "github469" | "--skip-context-validation -t {datasrc}/201401031400_rdr.xml" |  |
| 469 | 2 | "github469" | "--skip-context-validation -t {datasrc}/201401031400_rdr_max_FAIL.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.field_value_out_of_min_max_range=1" |
| 469 | 3 | "github469" | "--skip-context-validation -t {datasrc}/201401031400_rdr_min_FAIL.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.field_value_out_of_min_max_range=1" |
| 467 | 1 | "github476" | "-R pds4.label -t {datasrc}/bundle_mars2020_spice_v003.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.inventory.duplicate_lidvid=1" |
| 467 | 2 | "github476" | "-R pds4.label -t {datasrc}/collection_lab.hydrocarbon_spectra_data.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.inventory.duplicate_lidvid=1" |
...
| 416 | 2 | "github416" | "-R pds4.label -t {datasrc}/mix_raw_calib_mixs-c_sw_offset_table_20160301_invalid.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.invalid_object_definition=1" |
| 416 | 3 | "github416" | "-R pds4.label -t {datasrc}/phe_misc_temperature_reference_20190524.xml" |  |
| 416 | 4 | "github416" | "-R pds4.label -t {datasrc}/phe_misc_temperature_reference_20190524_invalid.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.invalid_object_definition=1" |
| 408 |  | "github408" | "-R pds4.bundle --skip-content-validation -t {datasrc}/valid/bundle_insight_seis.xml" |  |
| 401 |  | "github401" | "-R pds4.bundle -t {datasrc}/invalid/bundle_kaguya_derived.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.validation.invalid_field_value=1" |
| 392 | 1 | "github392" | "-R pds4.label --skip-context-validation -t {datasrc}/test1_valid.xml" |  |
| 392 | 2 | "github392" | "-R pds4.label --skip-context-validation -t {datasrc}/test1_invalid.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.field_value_overlap=1" |
| 392 | 3 | "github392" | "-R pds4.label --skip-context-validation -t {datasrc}/INVALID_odf07155_msgr_11.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.field_value_overlap=1" |
...
| 367 | 1 | "github367" | "-R pds4.bundle -t {datasrc}/bundle_kaguya_derived.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.pdf.file.not_pdfa_compliant=1" |
| 367 | 2 | "github367" | "-R pds4.bundle -t {datasrc}/bundle_kaguya_derived.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.file.not_jpeg_compliant=1" |
| 367 | 3 | "github367" | "-R pds4.bundle -t {datasrc}/bundle_kaguya_derived.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.file.not_png_compliant=1" |
...
| 366 | 1 | "github366" | "-R pds4.label --skip-context-validation -t {resourceDir}/github164/invalid/document_test_1_pdf.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.pdf.file.not_pdfa_compliant=1" |
...
| 364 | 2 | "github364" | "-R pds4.label --skip-product-validation --skip-context-validation --skip-content-validation -t {datasrc}//MIS000XXX_2021001T000000_DEV0_2021001T0000_RAW010" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.bad_extension=1" |
| 357 | 1 | "github357" | "-R pds4.label -t {datasrc}/whypointsremovedfromdata.xml" | "summary:totalErrors=0,summary:totalWarnings=2" |
| 357 | 2 | "github357" | "-R pds4.label -t {datasrc}/whypointsremovedfromdata_2240_records.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.validation.invalid_field_value=1" |
| 357 | 3 | "github357" | "-R pds4.label -t {datasrc}/whypointsremovedfromdata_2250_records.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.records_mismatch=1" |
| 357 | 4 | "github357" | "-R pds4.label -t {datasrc}/whypointsremovedfromdata_4_records.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.validation.invalid_field_value=1" |
...
| 349 | 2 | "github349" | "-R pds4.label -t {datasrc}/invalid/datasetbad.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.directory.unallowed_name=1" |
...
| 343 | 2 | "github343" | "-R pds4.label --skip-context-validation -t {datasrc}/test_data/I52_20210207_1A_U1B03A_01_0001.avgs_bad.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.array.value_out_of_min_max_range=1" |
| 343 | 3 | "github343" | "-R pds4.label --skip-context-validation -t {datasrc}/test_data/I52_20210207_1A_U1B03A_01_0001.avgs_bad_noname.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.array.value_out_of_min_max_range=1" |
...
| 334 | 2 | "github334" | "-R pds4.label -t {datasrc}/invalid/pvoro_graph_eden_k91_3a_01_v01_r00.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.invalid_object_definition=1" |
...
| 303 | 1 | "github303" | "-R pds4.label --skip-context-validation -t {datasrc}/invalid/I52_20210207_1A_U1B03A_01_0001.avgs.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.array.bad_file_read=1" |
...
| 298 | 2 | "github298" | "-R pds4.label {datasrc}/invalid/sentences.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.validation.invalid_field_value=1" |
...
| 294 | 2 | "github294" | "--skip-context-validation -R pds4.label -t {datasrc}/invalid/minmax-error.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.records_mismatch=1" |
| 292 | 1 | "github292" | "--skip-context-validation -C {reportDir}/catalog.xml -schema src/test/resources/github292/pds/v1/PDS4_PDS_1G00.xsd -schematron src/test/resources/github292/pds/v1/PDS4_PDS_1G00.sch -R pds4.label -t {datasrc}/table_delimited/kgrs_calibrated_spectra_per1_LF_VALID.xml" |  |
| 292 | 2 | "github292" | "--skip-context-validation -C {reportDir}/catalog.xml -schema src/test/resources/github292/pds/v1/PDS4_PDS_1G00.xsd -schematron src/test/resources/github292/pds/v1/PDS4_PDS_1G00.sch -R pds4.label -t {datasrc}/table_delimited/kgrs_calibrated_spectra_per1_CRLF_VALID.xml" |  |
| 292 | 3 | "github292" | "--skip-context-validation -C {reportDir}/catalog.xml -schema src/test/resources/github292/pds/v1/PDS4_PDS_1G00.xsd -schematron src/test/resources/github292/pds/v1/PDS4_PDS_1G00.sch -R pds4.label -t {datasrc}/table_delimited/kgrs_calibrated_spectra_per1_LF_FAIL.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.missing_LF=1" |
| 292 | 4 | "github292" | "--skip-context-validation -C {reportDir}/catalog.xml -schema src/test/resources/github292/pds/v1/PDS4_PDS_1G00.xsd -schematron src/test/resources/github292/pds/v1/PDS4_PDS_1G00.sch -R pds4.label -t {datasrc}/table_delimited/kgrs_calibrated_spectra_per1_CRLF_FAIL.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.missing_CRLF=1" |
| 292 | 5 | "github292" | "--skip-context-validation -C {reportDir}/catalog.xml -schema src/test/resources/github292/pds/v1/PDS4_PDS_1G00.xsd -schematron src/test/resources/github292/pds/v1/PDS4_PDS_1G00.sch -R pds4.label -t {datasrc}/table_character/valid/minimal_test_product_lf.xml" |  |
| 292 | 6 | "github292" | "--skip-context-validation -C {reportDir}/catalog.xml -schema src/test/resources/github292/pds/v1/PDS4_PDS_1G00.xsd -schematron src/test/resources/github292/pds/v1/PDS4_PDS_1G00.sch -R pds4.label -t {datasrc}/table_character/valid/minimal_test_product_crlf.xml" |  |
...
| 292 | 9 | "github292" | "--skip-context-validation -C {reportDir}/catalog.xml -schema src/test/resources/github292/pds/v1/PDS4_PDS_1G00.xsd -schematron src/test/resources/github292/pds/v1/PDS4_PDS_1G00.sch -R pds4.label -t {datasrc}/inventory/collection_eetable_inventory_LF_VALID.xml" |  |
| 292 | 10 | "github292" | "--skip-context-validation -C {reportDir}/catalog.xml -schema src/test/resources/github292/pds/v1/PDS4_PDS_1G00.xsd -schematron src/test/resources/github292/pds/v1/PDS4_PDS_1G00.sch -R pds4.label -t {datasrc}/inventory/collection_eetable_inventory_CRLF_VALID.xml" |  |
...
| 281 | 1 | "github281" | "-R pds4.label {datasrc}/invalid/collection_gwe_spk_invalid_1_bad_filesize.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.filesize_mismatch=1" |
| 281 | 2 | "github281" | "-R pds4.label {datasrc}/invalid/collection_gwe_spk_invalid_2_bad_checksum.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.checksum_mismatch=1" |
| 281 | 3 | "github281" | "-R pds4.label {datasrc}/invalid/collection_gwe_spk_invalid_3_bad_checksum_no_filesize.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.checksum_mismatch=1" |
...
| 278 | 1 | "github278" | "-R pds4.label {datasrc}/invalid/trk-2-34-revn-l5_tnf_invalid.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.context_ref_not_found=1" |
...
| 230 | 1 | "github230" | "--skip-content-validation -R pds4.bundle -t {datasrc}/invalid/cocirs_c2h4abund/bundle_cocirs_c2h4abund.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.integrity.missing_version=1" |
...
| 217 | 2 | "github217" | "-t {datasrc}/fail/delmet4.xml {datasrc}/fail/binobs4.xml {datasrc}/fail/delobs4.xml {datasrc}/fail/delinv4.xml {datasrc}/fail/ascbro4.xml {datasrc}/fail/delsup4.xml {datasrc}/fail/delanc4.xml {datasrc}/fail/binanc4.xml {datasrc}/fail/binsup4.xml {datasrc}/fail/ascsup4.xml {datasrc}/fail/delbro4.xml {datasrc}/fail/ascanc4.xml {datasrc}/fail/binbro4.xml {datasrc}/fail/ascmet4.xml {datasrc}/fail/ascobs4.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.records_mismatch=1" |
| 217 | 3 | "github217" | "-t {datasrc}/fail/delmet4.xml {datasrc}/fail/binobs4.xml {datasrc}/fail/delobs4.xml {datasrc}/fail/delinv4.xml {datasrc}/fail/ascbro4.xml {datasrc}/fail/delsup4.xml {datasrc}/fail/delanc4.xml {datasrc}/fail/binanc4.xml {datasrc}/fail/binsup4.xml {datasrc}/fail/ascsup4.xml {datasrc}/fail/delbro4.xml {datasrc}/fail/ascanc4.xml {datasrc}/fail/binbro4.xml {datasrc}/fail/ascmet4.xml {datasrc}/fail/ascobs4.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.table_definition_problem=1" |
| 210 |  | "github210" | "--skip-content-validation -t {datasrc}/bundle_cassini-huygens-coradar.xml {datasrc}/BILQH07S314_D065_T008S02_V02_without_Missing_Area_tag.xml" | "summary:totalErrors=1,summary:totalWarnings=0" |
| 209 | 1 | "github209" | "--disable-context-mismatch-warnings -t {datasrc}/VALID_odf07155_msgr_11.xml" |  |
| 209 | 2 | "github209" | "--disable-context-mismatch-warnings -t {datasrc}/FAIL1_overlapping_bit_fields.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.field_value_overlap=1" |
| 209 | 3 | "github209" | "--disable-context-mismatch-warnings -t {datasrc}/FAIL2_bad_stop_bit.xml" | "summary:totalErrors=2,summary:totalWarnings=0,summary:messageTypes:error.table.field_value_overlap=1,summary:messageTypes:error.table.bad_field_read=1" |
| 190 |  | "github190" | "--skip-context-validation -t {datasrc}/validation_test.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.field_value_data_type_mismatch=1" |
...
| 173 | 2 | "github173" | "--skip-context-validation -R pds4.bundle -t {datasrc}/invalid/ --skip-content-validation" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.records_mismatch=1" |
| 164 | 1 | "github164" | "-R pds4.label --skip-context-validation -t {datasrc}/invalid/document_test_1_pdf.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.pdf.file.not_pdfa_compliant=1" |
| 164 | 2 | "github164" | "-R pds4.label --skip-context-validation -t {datasrc}/valid/document_pdfa_valid.xml" |  |
| 153 | 1 | "github153" | "--skip-context-validation -R pds4.label -t {datasrc}/iue_asteroid_spectra/document/3juno_lwr01896_ines_fits_headers.pdfa%.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.file.name_has_invalid_characters=1" |
...
| 137 | 2 | "github137" | "-t {datasrc}/delimited_table_bad.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.field_value_data_type_mismatch=1" |
| 87 |  | "github87" | "-R pds4.label --skip-content-validation -t {datasrc}/2t126632959btr0200p3002n0a1.xml {datasrc}/2t126646972btr0200p3001n0a1.xml -C {reportDir}/catalog.xml" |  |
...
| 62 | 2 | "github62" | "-v1 --no-data-check -t {datasrc}/spacecraft.orex_1.1.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:info.label.context_ref_found=1,summary:messageTypes:error.label.context_ref_not_found=1" |
| 57 | 1 | "github57" | "-R pds4.label --strict-field-checks --skip-context-validation -t {datasrc}/validate_57a_valid.xml" | "summary:totalErrors=5,summary:totalWarnings=0" |
...
| 50 | 1 | "github50" | "--skip-content-validation --skip-context-validation --target-manifest {reportDir}/target-manifest.xml" |  |
| 50 | 2 | "github50" | "--target-manifest {reportDir}/target-manifest.xml -t {datasrc}/ele_evt_8hr_orbit_2014-2015.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.missing_file=1" |
...
| 47 | 2 | "github47" | "-v1 --skip-content-validation --disable-context-mismatch-warnings -R pds4.label {datasrc}/test_context_products.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.context_ref_not_found=1" |
...
| 17 | 1 | "github17" | "--skip-context-validation -R pds4.label -t {datasrc}/delimited_table_bad.xml" | "summary:totalErrors=3,summary:totalWarnings=0" |
...
| 15 | 2 | "github15" | "-v1 --disable-context-mismatch-warnings {datasrc}/test_check-no-pass_context_products.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.context_ref_not_found=1,summary:messageTypes:info.label.context_ref_mismatch=1" |
| 11 | 1 | "github11" | "-R pds4.label -t {datasrc}/test_data/science_index_bad_1.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.invalid_object_definition=1" |
| 11 | 2 | "github11" | "-R pds4.label -t {datasrc}/test_data/science_index_bad_2.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.label.invalid_object_definition=1" |
...
| 9 | 4 | "github09" | "-t {datasrc}/csv_empty_field_test_INVALID.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.field_value_data_type_mismatch=1" |
| 9 | 5 | "github09" | "-t {datasrc}/val9a.xml.xml" |  |
| 9 | 6 | "github09" | "-t {datasrc}/val9b.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.field_value_data_type_mismatch=1" |
...
| 5 | 1 | "github5" | "-R pds4.bundle --skip-context-validation -t {datasrc}/invalid/bundle_kaguya_derived.xml" | "summary:totalErrors=2,summary:totalWarnings=0,summary:messageTypes:error.file.name_has_invalid_characters=1,summary:messageTypes:error.file.unallowed_base_name=1" |
