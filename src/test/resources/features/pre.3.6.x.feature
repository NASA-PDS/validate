...
# So, the 1st error is the file name contains spaces from FileAndDirectoryNamingRule and the 2nd error comes from function validateFileStandardConformity().
 ...
 |"NASA-PDS/validate#51 1" | "github51" | 0 | "0 errors expected for totalErrors." | "totalErrors" | "src/test/resources" | "target/test" | "--skip-content-validation --skip-context-validation -r {reportDir}/report_github51_1.json -s json -t {resourceDir}/github51/valid" | "report_github51_1.json" |
...
# https://github.com/NASA-PDS/validate/issues/217
 |"NASA-PDS/validate#217 Success with Errors: Tables Types" | "github217" | 42 | "42 error message expected" | "totalErrors" | "src/test/resources" | "target/test" | "-r {reportDir}/report_github217.json  -s json -t {resourceDir}/github217/ascanc2.xml {resourceDir}/github217/ascanc3.xml {resourceDir}/github217/ascanc4.xml {resourceDir}/github217/ascbro2.xml {resourceDir}/github217/ascbro3.xml {resourceDir}/github217/ascbro4.xml {resourceDir}/github217/ascmet2.xml {resourceDir}/github217/ascmet3.xml {resourceDir}/github217/ascmet4.xml {resourceDir}/github217/ascobs2.xml {resourceDir}/github217/ascobs3.xml {resourceDir}/github217/ascobs4.xml {resourceDir}/github217/ascsup2.xml {resourceDir}/github217/ascsup3.xml {resourceDir}/github217/ascsup4.xml {resourceDir}/github217/binanc2.xml {resourceDir}/github217/binanc3.xml {resourceDir}/github217/binanc4.xml {resourceDir}/github217/binbro2.xml {resourceDir}/github217/binbro3.xml {resourceDir}/github217/binbro4.xml {resourceDir}/github217/binobs2.xml {resourceDir}/github217/binobs3.xml {resourceDir}/github217/binobs4.xml {resourceDir}/github217/binsup2.xml {resourceDir}/github217/binsup3.xml {resourceDir}/github217/binsup4.xml {resourceDir}/github217/delanc2.xml {resourceDir}/github217/delanc3.xml {resourceDir}/github217/delanc4.xml {resourceDir}/github217/delbro2.xml {resourceDir}/github217/delbro3.xml {resourceDir}/github217/delbro4.xml {resourceDir}/github217/delinv2.xml {resourceDir}/github217/delinv3.xml {resourceDir}/github217/delinv4.xml {resourceDir}/github217/delmet2.xml {resourceDir}/github217/delmet3.xml {resourceDir}/github217/delmet4.xml {resourceDir}/github217/delobs2.xml {resourceDir}/github217/delobs3.xml {resourceDir}/github217/delobs4.xml {resourceDir}/github217/delsup2.xml {resourceDir}/github217/delsup3.xml {resourceDir}/github217/delsup4.xml" | "report_github217.json" |
...
# https://github.com/NASA-PDS/validate/issues/57 As a user, I want to be warned when there are alphanumeric characters between fields in Table_Character
 ...
 |"NASA-PDS/validate#57 One ERROR on last line" | "github57" | 5 | "5 warning messages expected" | "CHARS_BETWEEN_FIELDS" | "src/test/resources" | "target/test" | "-R pds4.label --strict-field-checks --skip-context-validation -r {reportDir}/report_github57c.json  -s json -t {resourceDir}/github57/validate_57c.xml" | "report_github57c.json" |
...
# https://github.com/NASA-PDS/validate/issues/334 validate 2.1.0 snapshot fails on a label with 2 table_character
 ...
 |"NASA-PDS/validate#334 VALID" | "github334" | 2 | "2 error messages expected." | "INVALID_OBJECT_DEFINITION" | "src/test/resources" | "target/test" | "-R pds4.label -r {reportDir}/report_github334_label_invalid.json -s json -t {resourceDir}/github334/invalid/pvoro_graph_eden_k91_3a_01_v01_r00.xml" | "report_github334_label_invalid.json" |
...
# https://github.com/NASA-PDS/validate/issues/349 validate allows absolute path in directory_path_name but shouldn't
 ...
 |"NASA-PDS/validate#349 INVALID" | "github349" | 1 | "1 error messages expected" | "UNALLOWED_DIRECTORY_NAME" | "src/test/resources" | "target/test" | "-R pds4.label -r {reportDir}/report_github349_label_invalid.json -s json -t {resourceDir}/github349/invalid/datasetbad.xml" | "report_github349_label_invalid.json" |
