...
| 1541 | 1 | "github1541" | "--skip-context-validation -t {datasrc}/label_1541_1.xml --schema {datasrc}/PDS4_PDS_1Q00.xsd --schematron {datasrc}/PDS4_PDS_1Q00.sch" | "summary:productValidation:passed=1,summary:productValidation:total=1,summary:totalWarnings=0" |
| 1541 | 2 | "github1541" | "--skip-context-validation -t {datasrc}/label_1541_2.xml --schema {datasrc}/PDS4_PDS_1Q00.xsd --schematron {datasrc}/PDS4_PDS_1Q00.sch" | "summary:productValidation:passed=1,summary:productValidation:total=1,summary:totalWarnings=0" |
| 1542 | 1 | "github1542" | "--skip-context-validation -t {datasrc}/label_1542_1.xml --schema {datasrc}/PDS4_PDS_1Q00.xsd --schematron {datasrc}/PDS4_PDS_1Q00.sch" | "summary:productValidation:passed=1,summary:productValidation:total=1,summary:totalWarnings=0" |
