...
#| 1408 | 1 | "github1408" | " -t {datasrc}/tc_vl0axrat_table_delimited_valid.xml,{datasrc}/tc_vl0axrat_table_char_valid.xml" | "summary:totalErrors=1,summary:productValidation:failed=1,summary:messageTypes:error.label.table_definition_problem=1" |
#| 1408 | 1 | "github1408" | " -t {datasrc}/tc_vl0axrat_table_char_valid.xml,{datasrc}/tc_vl0axrat_table_delimited_valid.xml" | "summary:totalErrors=1,summary:productValidation:failed=1,summary:messageTypes:error.label.table_definition_problem=1" |
#| 1408 | 1 | "github1408" | " -t {datasrc}/*.xml" | "summary:totalErrors=1,summary:productValidation:failed=1,summary:messageTypes:error.label.table_definition_problem=1" |
...
#| 1370 | 1 | "github1370" | " -t {datasrc}/" |  |  SKIP per issue#1440
...
#| 1331 | 1 | "github1331" | " -t {datasrc}/" |  |  SKIP PER issue#1440
...
#| 1149 | 1 | "github1149" | " -t {datasrc}/" |  |  SKIP PER issue#1440
