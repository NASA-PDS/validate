...
# Validate#681
|"NASA-PDS/validate#681 Success new constant expression" | "github681" | 1 | "1 errors expected" | "FIELD_VALUE_DATA_TYPE_MISMATCH" | "src/test/resources" | "target/test" | "-r {reportDir}/report_github691.json -s json --skip-context-validation  -t {resourceDir}/github681/ff_char.xml {resourceDir}/github681/ff_del.xml" | "report_github681.json" |
