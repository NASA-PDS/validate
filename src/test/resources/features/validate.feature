...
# https://github.com/NASA-PDS/validate/issues/57 As a user, I want to be warned when there are alphanumeric characters between fields in Table_Character
 ...
 |"NASA-PDS/validate#57 One ERROR on last line" | "github57" | 7 | "7 warning messages expected" | "CHARS_BETWEEN_FIELDS" | "src/test/resources" | "target/test" | "-R pds4.label --strict-field-checks --skip-context-validation -r {reportDir}/report_github57c.json  -s json -t {resourceDir}/github57/validate_57c.xml" | "report_github57c.json" |
