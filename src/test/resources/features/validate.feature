...
# Break up github367 one test into  multiple tests for accounting purposes, i.g. each problem type has its own count.
 ...
 |"NASA-PDS/validate#367 11_NON_RICHTEXT_FILE" | "github367" | 1 | "11 : 1 NON_RICHTEXT_FILE warn messages expected" | "NON_RICHTEXT_FILE" | "src/test/resources" | "target/test" | "-R pds4.bundle -r {reportDir}/report_github367_bundle_valid_NON_RICHTEXT_FILE.json -s json -t {resourceDir}/github367/bundle_kaguya_derived.xml" | "report_github367_bundle_valid_NON_RICHTEXT_FILE.json" |
