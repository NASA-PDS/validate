...
|"NASA-PDS/validate#467 Duplicate LIDVIDs in Bundle" | "github476" | 1 | "1 errors expected" | "INVENTORY_DUPLICATE_LIDVID" | "src/test/resources" | "target/test" | "-r {reportDir}/report_github476b.json -s json -R pds4.label -t {resourceDir}/github476/bundle_mars2020_spice_v003.xml" | "report_github476b.json" |
