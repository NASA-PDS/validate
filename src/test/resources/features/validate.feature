...
|"NASA-PDS/validate#482 Failure Test Bundle - No Products Found" | "github482" | 1 | "1 error expected" | "error.execution.no_products_found" | "src/test/resources" | "target/test" | "-r {reportDir}/report_github482_5.json -s json -R pds4.folder -t {resourceDir}/github482/bundle1/" | "report_github482_5.json" |
|"NASA-PDS/validate#482 Failure Test Bundle - No Products Found" | "github482" | 1 | "1 error expected" | "error.execution.no_products_found" | "src/test/resources" | "target/test" | "-r {reportDir}/report_github482_6.json -s json -R pds4.folder -e lblx -t {resourceDir}/github482/bundle2/" | "report_github482_6.json" |
