...
| 1066 | 1 | "github1066" | "--skip-content-validation -t {datasrc}/vg2u_49xr_1986024t232141.xml" | "summary:totalWarnings=3,summary:messageTypes:warning.label.context_ref_mismatch=3" |
...
| 915 | 1 | "github915" | "--skip-content-validation --skip-context-validation -R pds4.collection -t {datasrc}/collection.xml" | "summary:totalErrors=1,summary:totalWarnings=1,summary:productValidation:failed=1,summary:messageTypes:error.label.duplicate_identifier=1,summary:messageTypes:warning.integrity.unreferenced_member=1" |
...
| 902 | 2 | "github902" | "--skip-content-validation --skip-context-validation -t {datasrc}/s_00168901_thm.xml" |  |
...
| 861 | 1 | "github861" | "-t {datasrc}/PVO_OMAG_OEFD_ANC_ENG_0001.xml" | "summary:totalWarnings=1,summary:messageTypes:warning.label.context_ref_mismatch=1" |
| 857 | 1 | "github857" | "-t {datasrc}/highi_183_istria_fam3.xml" | "summary:totalWarnings=2,summary:messageTypes:warning.label.context_ref_mismatch=2" |
...
| 849 | 2 | "github849" | "--skip-context-validation -t {datasrc}/collection.xml" | "summary:totalErrors=1,summary:productValidation:failed=1,summary:messageTypes:error.inventory.duplicate_lidvid=1" |
...
| 824 | 2 | "github824" | "--skip-content-validation --skip-context-validation -t {datasrc}/1203_12.xml" |  |
