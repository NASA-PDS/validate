...
| 1008 |  | "github1008" | "--skip-context-validation -t {datasrc}/example.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.pdf.file.not_pdfa_compliant=1" |
...
| 849 | 1 | "github849" | "--skip-context-validation -t {datasrc}/collection_uvs_data_raw.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.inventory.duplicate_lidvid=1" |
| 849 | 2 | "github849" | "-t {datasrc}/collection.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.inventory.duplicate_lidvid=1" |
...
| 816 | 1 | "github681" | "-t {datasrc}/ff_char_fail.xml" | "summary:totalErrors=1,summary:totalWarnings=0,summary:messageTypes:error.table.field_value_format_precision_mismatch=1" |
