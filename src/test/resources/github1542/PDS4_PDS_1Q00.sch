<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:pds  Version:1.26.0.0 - Wed May 27 12:31:24 PDT 2026 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="/*[not(contains(name(), 'External') or contains(name(), 'Ingest') or contains(name(), 'Bundle') or contains(name(), 'Collection'))]/pds:Identification_Area/pds:logical_identifier">
      <sch:assert test="count(tokenize(.,':'))=6">
  ...
  <sch:pattern>
    <sch:rule context="/*[contains(name(), 'External')]/pds:Identification_Area/pds:logical_identifier">
      <sch:let name="num_segments" value="count(tokenize(.,':'))"/>
      <sch:let name="required_segments" value="6"/>
      <sch:assert test="$num_segments eq $required_segments">
        <title>pds:/Product_Observational/pds:Identification_Area/pds:logical_identifier_external/logical_identifier</title>
        In Product_External, the number of segments found: (<sch:value-of select="$num_segments"/>) is inconsistent with the number expected: (<sch:value-of select="$required_segments"/>).</sch:assert>
  ...
  <sch:pattern>
    <sch:rule context="pds:Array_1D_Spectrum/pds:axes">
      <sch:assert test=". = ('1')">
        <title>pds:Array_1D_Spectrum/pds:axes/pds:axes</title>
        The attribute pds:Array_1D_Spectrum/pds:axes must be equal to the value '1'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Array_1D_Spectrum/pds:axis_index_order">
      <sch:assert test=". = ('Last Index Fastest')">
        <title>pds:Array_1D_Spectrum/pds:axis_index_order/pds:axis_index_order</title>
        The attribute pds:Array_1D_Spectrum/pds:axis_index_order must be equal to the value 'Last Index Fastest'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Bundle/pds:bundle_type">
      <sch:assert test=". = ('Archive', 'External', 'Supplemental')">
        <title>pds:Bundle/pds:bundle_type/pds:bundle_type</title>
        The attribute pds:Bundle/pds:bundle_type must be equal to one of the following values 'Archive', 'External', 'Supplemental'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Citation_Information/pds:author_list" role="warning">
      <sch:assert test="false()">
        <title>pds:Citation_Information/pds:author_list role="warning"/pds:Citation_Information.author_list</title>
        pds:Citation_Information/pds:author_list is deprecated and should not be used.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Citation_Information/pds:editor_list" role="warning">
      <sch:assert test="false()">
        <title>pds:Citation_Information/pds:editor_list role="warning"/pds:Citation_Information.editor_list</title>
        pds:Citation_Information/pds:editor_list is deprecated and should not be used.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Collection/pds:collection_type">
      <sch:assert test=". = ('Browse', 'Calibration', 'Context', 'Data', 'Document', 'External', 'Geometry', 'Miscellaneous', 'SPICE Kernel', 'XML Schema')">
        <title>pds:Collection/pds:collection_type/pds:collection_type</title>
        The attribute pds:Collection/pds:collection_type must be equal to one of the following values 'Browse', 'Calibration', 'Context', 'Data', 'Document', 'External', 'Geometry', 'Miscellaneous', 'SPICE Kernel', 'XML Schema'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Document" role="warning">
      <sch:let name="count_file_name" value="count(//pds:file_name)"/>
      <sch:let name="distinct_file_name" value="count(distinct-values(//pds:file_name))"/>
      <sch:let name="difference_file_name" value="$count_file_name - $distinct_file_name"/>
      <sch:assert test="$count_file_name eq $distinct_file_name">
        <title>pds:Document/file_name</title>
        The number of instances of 'file_name' is: '<sch:value-of select="$count_file_name"/>'. The number of distinct instances of 'file_name' is: '<sch:value-of select="$distinct_file_name"/>'. The number of duplicate instances of 'file_name' is: '<sch:value-of select="$difference_file_name"/>'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Document/pds:author_list" role="warning">
      <sch:assert test="false()">
        <title>pds:Document/pds:author_list role="warning"/pds:Document.author_list</title>
        pds:Document/pds:author_list is deprecated and should not be used.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Document/pds:editor_list" role="warning">
      <sch:assert test="false()">
        <title>pds:Document/pds:editor_list role="warning"/pds:Document.editor_list</title>
        pds:Document/pds:editor_list is deprecated and should not be used.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Encoded_Native/pds:encoding_standard_id">
      <sch:assert test=". = ('MSSS Original Data Record Mini Header', 'MSSS Original Data Record Payload Data', 'Nikon Electronic Format (NEF)', 'SEED 2.4')">
        <title>pds:Encoded_Native/pds:encoding_standard_id/pds:encoding_standard_id</title>
        The attribute pds:Encoded_Native/pds:encoding_standard_id must be equal to one of the following values 'MSSS Original Data Record Mini Header', 'MSSS Original Data Record Payload Data', 'Nikon Electronic Format (NEF)', 'SEED 2.4'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Encoded_Video/pds:encoding_standard_id">
      <sch:assert test=". = ('MP4/H.264', 'MP4/H.264/AAC')">
        <title>pds:Encoded_Video/pds:encoding_standard_id/pds:encoding_standard_id</title>
        The attribute pds:Encoded_Video/pds:encoding_standard_id must be equal to one of the following values 'MP4/H.264', 'MP4/H.264/AAC'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Funder_Identifier/pds:funder_identifier_type">
      <sch:assert test=". = ('Crossref funder ID', 'GRID', 'ISNI', 'ORCID', 'Other', 'RORID')">
        <title>pds:Funder_Identifier/pds:funder_identifier_type/pds:funder_identifier_type</title>
        The attribute pds:Funder_Identifier/pds:funder_identifier_type must be equal to one of the following values 'Crossref funder ID', 'GRID', 'ISNI', 'ORCID', 'Other', 'RORID'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Identification_Area">
      <sch:let name="LID" value="string(pds:logical_identifier)"/>
      <sch:let name="agencyPrefixes" value="'(urn:nasa:pds:, urn:esa:psa:, urn:ros:rssa:, urn:jaxa:darts:, urn:isro:isda:, urn:kari:kpds:)'"/>
      <sch:let name="thisPrefix" value="string-join((subsequence(tokenize($LID,':'),1,3),''),':')"/>
      <sch:let name="prodExternal" value="local-name(/*) = 'Product_External'"/>
      <sch:let name="bundExternal" value="//pds:bundle_type = 'External'"/>
      <sch:let name="collExternal" value="//pds:collection_type = 'External'"/>
      ...
      <sch:assert test="if (not ($prodExternal or $bundExternal or $collExternal)) then (contains($agencyPrefixes, $thisPrefix)) else true()">
        <title>pds:Identification_Area/logical_identifier</title>
        An archive product pds:logical_identifier must begin with one of <sch:value-of select="$agencyPrefixes"/>.</sch:assert>
      <sch:assert test="if ($prodExternal) then (not (contains($agencyPrefixes, $thisPrefix))) else true()">
        <title>pds:Identification_Area/logical_identifier</title>
        The pds:logical_identifier of a pds:Product_External may not begin with any of <sch:value-of select="$agencyPrefixes"/>.</sch:assert>
      <sch:assert test="if ($bundExternal) then (not (contains($agencyPrefixes, $thisPrefix))) else true()">
        <title>pds:Identification_Area/logical_identifier</title>
        The pds:logical_identifier of a pds:Product_Bundle with pds:bundle_type of "External" may not begin with any of <sch:value-of select="$agencyPrefixes"/>.</sch:assert>
      <sch:assert test="if ($collExternal) then (not (contains($agencyPrefixes, $thisPrefix))) else true()">
        <title>pds:Identification_Area/logical_identifier</title>
        The pds:logical_identifier of a pds:Product_Collection with pds:collection_type of "External" may not begin with any of <sch:value-of select="$agencyPrefixes"/>.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Identification_Area/pds:information_model_version">
      <sch:assert test=". = ('1.26.0.0')">
        <title>pds:Identification_Area/pds:information_model_version/pds:information_model_version</title>
        The attribute pds:Identification_Area/pds:information_model_version must be equal to the value '1.26.0.0'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Identification_Area/pds:product_class">
      <sch:assert test=". = ('Product_AIP', 'Product_Ancillary', 'Product_Attribute_Definition', 'Product_Browse', 'Product_Bundle', 'Product_Class_Definition', 'Product_Collection', 'Product_Context', 'Product_DIP', 'Product_DIP_Deep_Archive', 'Product_Data_Set_PDS3', 'Product_Document', 'Product_External', 'Product_File_Repository', 'Product_File_Text', 'Product_Instrument_Host_PDS3', 'Product_Instrument_PDS3', 'Product_Metadata_Supplemental', 'Product_Mission_PDS3', 'Product_Native', 'Product_Observational', 'Product_Proxy_PDS3', 'Product_Resource', 'Product_SIP', 'Product_SIP_Deep_Archive', 'Product_SPICE_Kernel', 'Product_Service', 'Product_Software', 'Product_Subscription_PDS3', 'Product_Target_PDS3', 'Product_Thumbnail', 'Product_Update', 'Product_Volume_PDS3', 'Product_Volume_Set_PDS3', 'Product_XML_Schema', 'Product_Zipped')">
        <title>pds:Identification_Area/pds:product_class/pds:product_class</title>
        The attribute pds:Identification_Area/pds:product_class must be equal to one of the following values 'Product_AIP', 'Product_Ancillary', 'Product_Attribute_Definition', 'Product_Browse', 'Product_Bundle', 'Product_Class_Definition', 'Product_Collection', 'Product_Context', 'Product_DIP', 'Product_DIP_Deep_Archive', 'Product_Data_Set_PDS3', 'Product_Document', 'Product_External', 'Product_File_Repository', 'Product_File_Text', 'Product_Instrument_Host_PDS3', 'Product_Instrument_PDS3', 'Product_Metadata_Supplemental', 'Product_Mission_PDS3', 'Product_Native', 'Product_Observational', 'Product_Proxy_PDS3', 'Product_Resource', 'Product_SIP', 'Product_SIP_Deep_Archive', 'Product_SPICE_Kernel', 'Product_Service', 'Product_Software', 'Product_Subscription_PDS3', 'Product_Target_PDS3', 'Product_Thumbnail', 'Product_Update', 'Product_Volume_PDS3', 'Product_Volume_Set_PDS3', 'Product_XML_Schema', 'Product_Zipped'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Instrument_Host" role="warning">
      <sch:assert test="pds:type != 'Earth Based'">
        <title>pds:Instrument_Host role="warning"/pds:Instrument_Host.type</title>
  ...
  <sch:pattern>
    <sch:rule context="pds:Internal_Reference">
      ...
      <sch:let name="urn_kari" value="'urn:kari:kpds:'"/>
      ...
      <sch:assert test="if (pds:lid_reference) then starts-with(pds:lid_reference, $urn_nasa) or starts-with(pds:lid_reference, $urn_esa) or starts-with(pds:lid_reference, $urn_jaxa) or starts-with(pds:lid_reference, $urn_ros) or starts-with(pds:lid_reference, $urn_isro)  or starts-with(pds:lid_reference, $urn_kari) else true()">
        <title>pds:Internal_Reference/lid_reference</title>
        The value of the attribute lid_reference must start with either: <sch:value-of select="$urn_nasa"/> or <sch:value-of select="$urn_esa"/> or <sch:value-of select="$urn_jaxa"/> or <sch:value-of select="$urn_ros"/> or <sch:value-of select="$urn_isro"/> or <sch:value-of select="$urn_kari"/></sch:assert>
      <sch:assert test="if (pds:lidvid_reference) then starts-with(pds:lidvid_reference, $urn_nasa) or starts-with(pds:lidvid_reference, $urn_esa) or starts-with(pds:lidvid_reference, $urn_jaxa) or starts-with(pds:lidvid_reference, $urn_ros) or starts-with(pds:lidvid_reference, $urn_isro) or starts-with(pds:lidvid_reference, $urn_kari) else true()">
        <title>pds:Internal_Reference/lidvid_reference</title>
        The value of the attribute lidvid_reference must start with either: <sch:value-of select="$urn_nasa"/> or <sch:value-of select="$urn_esa"/> or <sch:value-of select="$urn_jaxa"/> or <sch:value-of select="$urn_ros"/> or <sch:value-of select="$urn_isro"/> or <sch:value-of select="$urn_kari"/></sch:assert>
  ...
  <sch:pattern>
    <sch:rule context="pds:Inventory" role="warning">
      <sch:assert test="pds:field_delimiter != 'comma'">
        <title>pds:Inventory role="warning"/pds:Inventory.field_delimiter</title>
  ...
  <sch:pattern>
    <sch:rule context="pds:Manifest_SIP_Deep_Archive" role="warning">
      <sch:assert test="pds:field_delimiter != 'comma'">
        <title>pds:Manifest_SIP_Deep_Archive role="warning"/pds:Manifest_SIP_Deep_Archive.field_delimiter</title>
        The value comma for attribute Manifest_SIP_Deep_Archive.field_delimiter is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:field_delimiter != 'horizontal tab'">
        <title>pds:Manifest_SIP_Deep_Archive role="warning"/pds:Manifest_SIP_Deep_Archive.field_delimiter</title>
        The value horizontal tab for attribute Manifest_SIP_Deep_Archive.field_delimiter is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:field_delimiter != 'semicolon'">
        <title>pds:Manifest_SIP_Deep_Archive role="warning"/pds:Manifest_SIP_Deep_Archive.field_delimiter</title>
        The value semicolon for attribute Manifest_SIP_Deep_Archive.field_delimiter is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:field_delimiter != 'vertical bar'">
        <title>pds:Manifest_SIP_Deep_Archive role="warning"/pds:Manifest_SIP_Deep_Archive.field_delimiter</title>
        The value vertical bar for attribute Manifest_SIP_Deep_Archive.field_delimiter is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:record_delimiter != 'carriage-return line-feed'">
        <title>pds:Manifest_SIP_Deep_Archive role="warning"/pds:Manifest_SIP_Deep_Archive.field_delimiter</title>
        The value carriage-return line-feed for attribute Manifest_SIP_Deep_Archive.record_delimiter is deprecated and should not be used.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Node" role="warning">
      <sch:assert test="pds:name != 'Imaging'">
        <title>pds:Node role="warning"/pds:Node.name</title>
        The value Imaging for attribute Node.name is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:name != 'Navigation Ancillary Information Facility'">
        <title>pds:Node role="warning"/pds:Node.name</title>
        The value Navigation Ancillary Information Facility for attribute Node.name is deprecated and should not be used.</sch:assert>
  ...
  <sch:pattern>
    <sch:rule context="pds:sequence_number">
      <sch:let name="parentNode" value="local-name(parent::*)"/>
      <sch:let name="parentObj" value="$parentNode = ('Person', 'Organization', 'Parent_Organization', 'Affiliation')"/>
      <sch:assert test="(not(. = 0 and $parentObj))">
        <title>pds:Organization/sequence_number</title>
        The minimum value of sequence_number within the context of 'Person' or 'Organization' or 'Parent_Organization' or 'Affiliation' is 1.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Organization/pds:contributor_type">
      <sch:let name="parentNode" value="local-name(parent::*)"/>
      <sch:let name="parentObj" value="$parentNode = ('List_Contributor')"/>
      <sch:let name="parentNode2" value="local-name(parent::*/parent::*)"/>
      <sch:let name="parentObj2" value="$parentNode2 = ('List_Contributor')"/>
      <sch:assert test="($parentObj2)">
        <title>pds:Organization/pds:contributor_type/contributor_type</title>
        The atribute 'pds:Organization/pds:contributor_type' can only be used within the context of 'List_Contributor'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:PDS_Affiliate" role="warning">
      <sch:assert test="pds:team_name != 'Imaging'">
        <title>pds:PDS_Affiliate role="warning"/pds:PDS_Affiliate.team_name</title>
  ...
  <sch:pattern>
    <sch:rule context="pds:Person/pds:contributor_type">
      <sch:assert test=". = ('DataCollector', 'DataCurator', 'Producer')">
        <title>pds:Person/pds:contributor_type/pds:contributor_type</title>
        The attribute pds:Person/pds:contributor_type must be equal to one of the following values 'DataCollector', 'DataCurator', 'Producer'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_Ancillary/pds:Identification_Area/pds:License_Information/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('product_to_license')">
        <title>pds:Product_Ancillary/pds:Identification_Area/pds:License_Information/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'product_to_license'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_Browse/pds:Context_Area/pds:Target_Identification/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('browse_to_target')">
        <title>pds:Product_Browse/pds:Context_Area/pds:Target_Identification/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'browse_to_target'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Product_Browse/pds:Identification_Area/pds:License_Information/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('product_to_license')">
        <title>pds:Product_Browse/pds:Identification_Area/pds:License_Information/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'product_to_license'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_Bundle/pds:Context_Area/pds:Target_Identification/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('bundle_to_target')">
        <title>pds:Product_Bundle/pds:Context_Area/pds:Target_Identification/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'bundle_to_target'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_Bundle/pds:Identification_Area/pds:License_Information/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('product_to_license')">
        <title>pds:Product_Bundle/pds:Identification_Area/pds:License_Information/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'product_to_license'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Product_Bundle/pds:Identification_Area/pds:logical_identifier">
      <sch:let name="num_segments" value="count(tokenize(.,':'))"/>
      <sch:let name="required_segments" value="4"/>
      <sch:assert test="$num_segments eq $required_segments">
        <title>pds:Product_Bundle/pds:Identification_Area/pds:logical_identifier/logical_identifier</title>
        In Product_Bundle, the number of segments found: (<sch:value-of select="$num_segments"/>) is inconsistent with the number expected: (<sch:value-of select="$required_segments"/>).</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_Collection/pds:Context_Area/pds:Target_Identification/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('collection_to_target')">
        <title>pds:Product_Collection/pds:Context_Area/pds:Target_Identification/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'collection_to_target'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_Collection/pds:Identification_Area/pds:License_Information/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('product_to_license')">
        <title>pds:Product_Collection/pds:Identification_Area/pds:License_Information/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'product_to_license'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Product_Collection/pds:Identification_Area/pds:logical_identifier">
      <sch:let name="num_segments" value="count(tokenize(.,':'))"/>
      <sch:let name="required_segments" value="5"/>
      <sch:assert test="$num_segments eq $required_segments">
        <title>pds:Product_Collection/pds:Identification_Area/pds:logical_identifier/logical_identifier</title>
        In Product_Collection, the number of segments found: (<sch:value-of select="$num_segments"/>) is inconsistent with the number expected: (<sch:value-of select="$required_segments"/>).</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_Context/pds:Identification_Area/pds:License_Information/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('product_to_license')">
        <title>pds:Product_Context/pds:Identification_Area/pds:License_Information/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'product_to_license'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_Document/pds:Identification_Area/pds:License_Information/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('product_to_license')">
        <title>pds:Product_Document/pds:Identification_Area/pds:License_Information/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'product_to_license'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_External/pds:Context_Area/pds:Target_Identification/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('external_to_target')">
        <title>pds:Product_External/pds:Context_Area/pds:Target_Identification/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'external_to_target'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Product_External/pds:Identification_Area/pds:License_Information/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('product_to_license')">
        <title>pds:Product_External/pds:Identification_Area/pds:License_Information/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'product_to_license'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_File_Text/pds:Identification_Area/pds:License_Information/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('product_to_license')">
        <title>pds:Product_File_Text/pds:Identification_Area/pds:License_Information/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'product_to_license'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Product_Metadata_Supplemental/pds:Identification_Area/pds:License_Information/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('product_to_license')">
        <title>pds:Product_Metadata_Supplemental/pds:Identification_Area/pds:License_Information/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'product_to_license'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Product_Native/pds:Context_Area/pds:Target_Identification/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('native_to_target')">
        <title>pds:Product_Native/pds:Context_Area/pds:Target_Identification/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'native_to_target'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Product_Native/pds:Identification_Area/pds:License_Information/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('product_to_license')">
        <title>pds:Product_Native/pds:Identification_Area/pds:License_Information/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'product_to_license'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_Observational/pds:Identification_Area/pds:License_Information/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('product_to_license')">
        <title>pds:Product_Observational/pds:Identification_Area/pds:License_Information/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'product_to_license'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_SPICE_Kernel/pds:Context_Area/pds:Target_Identification/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('data_to_target')">
        <title>pds:Product_SPICE_Kernel/pds:Context_Area/pds:Target_Identification/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'data_to_target'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_XML_Schema/pds:Context_Area/pds:Target_Identification/pds:Internal_Reference">
      <sch:assert test="every $ref in (pds:reference_type) satisfies $ref = ('schema_to_target')">
        <title>pds:Product_XML_Schema/pds:Context_Area/pds:Target_Identification/pds:Internal_Reference/reference_type</title>
        The attribute reference_type must be set to one of the following values 'schema_to_target'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Software/pds:author_list" role="warning">
      <sch:assert test="false()">
        <title>pds:Software/pds:author_list role="warning"/pds:Software.author_list</title>
        pds:Software/pds:author_list is deprecated and should not be used.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Table_Delimited" role="warning">
      <sch:assert test="pds:field_delimiter != 'comma'">
        <title>pds:Table_Delimited role="warning"/pds:Table_Delimited.field_delimiter</title>
  ...
  <sch:pattern>
    <sch:rule context="pds:Table_Delimited_Source_Product_External" role="warning">
      <sch:assert test="pds:field_delimiter != 'comma'">
        <title>pds:Table_Delimited_Source_Product_External role="warning"/pds:Table_Delimited_Source_Product_External.field_delimiter</title>
  ...
  <sch:pattern>
    <sch:rule context="pds:Table_Delimited_Source_Product_Internal" role="warning">
      <sch:assert test="pds:field_delimiter != 'comma'">
        <title>pds:Table_Delimited_Source_Product_Internal role="warning"/pds:Table_Delimited_Source_Product_Internal.field_delimiter</title>
  ...
  <sch:pattern>
    <sch:rule context="pds:Terminological_Entry/pds:mapping_type">
      <sch:assert test=". = ('pds4_attribute_replacedby_term', 'pds4_attribute_replaces_column', 'pds4_attribute_replaces_pds3_attribute', 'pds4_attribute_replaces_pds4_attribute')">
        <title>pds:Terminological_Entry/pds:mapping_type/pds:mapping_type</title>
        The attribute pds:Terminological_Entry/pds:mapping_type must be equal to one of the following values 'pds4_attribute_replacedby_term', 'pds4_attribute_replaces_column', 'pds4_attribute_replaces_pds3_attribute', 'pds4_attribute_replaces_pds4_attribute'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
