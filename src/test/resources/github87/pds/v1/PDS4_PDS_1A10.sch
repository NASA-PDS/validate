...
<!-- PDS4 Schematron for Name Space Id:pds  Version:1.10.1.0 - Tue May 01 15:33:05 PDT 2018 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="pds:Identification_Area/pds:information_model_version">
      <sch:assert test=". = ('1.10.1.0')">
        The attribute pds:information_model_version must be equal to the value '1.10.1.0'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Terminological_Entry_SKOS/pds:model_object_type">
      <sch:assert test=". = ('Attribute', 'Class', 'Keyword', 'Nuance')">
        The attribute pds:model_object_type must be equal to one of the following values 'Attribute', 'Class', 'Keyword', 'Nuance'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
