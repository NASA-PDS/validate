<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:pds  Version:1.12.0.0 - Thu Mar 21 13:26:40 PDT 2019 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="pds:Airborne" role="warning">
      ...
      <sch:assert test="pds:type != 'Aircraft'">
        The value Aircraft for attribute Airborne.type is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:type != 'Balloon'">
        The value Balloon for attribute Airborne.type is deprecated and should not be used.</sch:assert>
      <sch:assert test="pds:type != 'Suborbital Rocket'">
        The value Suborbital Rocket for attribute Airborne.type is deprecated and should not be used.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="pds:Identification_Area/pds:information_model_version">
      <sch:assert test=". = ('1.12.0.0')">
        The attribute pds:information_model_version must be equal to the value '1.12.0.0'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
