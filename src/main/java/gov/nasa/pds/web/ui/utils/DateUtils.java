...
public class DateUtils {
  ...
  public static final SimpleDateFormat MYSQL_DATE_FORMAT =
      new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.US); //$NON-NLS-1$
  ...
  private static SimpleDateFormat[] formats = {new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'"),
      new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS"),
      new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'"),
      new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss"), new SimpleDateFormat("yyyy-MM-dd'T'HH:mm'Z'"),
      new SimpleDateFormat("yyyy-MM-dd'T'HH:mm"), new SimpleDateFormat("yyyy-MM-dd'T'HH'Z'"),
      new SimpleDateFormat("yyyy-MM-dd'T'HH"), new SimpleDateFormat("yyyy-MM-dd"),
      ...
      new SimpleDateFormat("yyyy-DDD'T'HH:mm:ss'Z'"), new SimpleDateFormat("yyyy-DDD'T'HH:mm:ss"),
      new SimpleDateFormat("yyyy-DDD'T'HH:mm'Z'"), new SimpleDateFormat("yyyy-DDD'T'HH:mm"),
      new SimpleDateFormat("yyyy-DDD'T'HH'Z'"), new SimpleDateFormat("yyyy-DDD'T'HH"),
  ...
  /*
   * tests string value to find a pattern in DateUtils.formats that matches, if none found returns
   * null
   * 
  ...
  public static String toGMTString(Date date) {
    SimpleDateFormat formatter = new SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss z", Locale.US); //$NON-NLS-1$
