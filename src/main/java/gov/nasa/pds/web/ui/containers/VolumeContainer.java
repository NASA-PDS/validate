...
public class VolumeContainer implements BaseContainerInterface {
  ...
  public VolumeContainer(LocaleUtils localeUtils, final String name, final String volId,
      final String setId, final String relPath, Status status, String createdBy, DataType type,
      UUID uuid) {
