...
public class BinaryPDS4ConversionUtils {
  ...
  public static long convertUnsignedLSBIntegers(byte[] b, int n) {
    ...
    if (n == 8) {
      anUnsignedInt = ((0xFF & (b[7])) << 56 | (0xFF & (b[6])) << 48 | (0xFF & (b[5])) << 40
          | (0xFF & (b[4])) << 32 | (0xFF & (b[3])) << 24 | (0xFF & (b[2])) << 16
          | (0xFF & (b[1])) << 8 | (0xFF & (b[0]))) & 0xFFFFFFFFFFFFFFFFL;
    }
   ...
   * 
   * Converts an array of bytes into a long, permitting unsigned bytes. The array of bytes may be of
   * length 2, 4, or 8, in big-endian order. That is, b[0] holds the most significant bits, b[n-1]
   * the least.
   * 
   * @param b the array of bytes, in big-endian order
   * @param n the number of bytes to convert in the array, from 1 to the size of an int
  ...
  public static long convertUnsignedMSBIntegers(byte[] b, int n) {
    ...
    if (n == 8) {
      anUnsignedInt = ((0xFF & (b[0])) << 56 | (0xFF & (b[1])) << 48 | (0xFF & (b[2])) << 40
          | (0xFF & (b[3])) << 32 | (0xFF & (b[4])) << 24 | (0xFF & (b[5])) << 16
          | (0xFF & (b[6])) << 8 | (0xFF & (b[7]))) & 0xFFFFFFFFFFFFFFFFL;
    }
  ...
  /**
   * 
   * Converts an array of bytes into a long, permitting unsigned bytes. The array of bytes is of
   * size 1 byte
   * 
   * @param b the array of bytes, in big-endian order
   * @param n the number of bytes to convert in the array, from 1 to the size of an int
  ...
  public static short convertByteArrayToShort(byte[] b) {
    ...
    aSignedShort = (short) (((short) (0xFF & b[0]) << 8) | ((short) (0xFF & b[1])));
  ...
  public static int IEEE754LSBToIEEE754MSBSingle(byte[] b) {
    ...
    msbSingleInt = ((0x000000FF & b[3]) << 24) | ((0x000000FF & b[2]) << 16)
        | ((0x000000FF & b[1]) << 8) | (0x000000FF & b[0]);
  ...
  public static long IEEE754LSBToIEEE754MSBDouble(byte[] b) {
    ...
    msbDoubleLong = ((0x00000000000000FFL & b[7]) << 56) | ((0x00000000000000FFL & b[6]) << 48)
        | ((0x00000000000000FFL & b[5]) << 40) | ((0x00000000000000FFL & b[4]) << 32)
        | ((0x00000000000000FFL & b[3]) << 24) | ((0x00000000000000FFL & b[2]) << 16)
        | ((0x00000000000000FFL & b[1]) << 8) | (0x00000000000000FFL & b[0]);
