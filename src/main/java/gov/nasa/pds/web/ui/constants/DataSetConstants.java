...
public class DataSetConstants {
  ...
  public static final String[] NON_INDEXED_FOLDERS = new String[] {"INDEX", "DOCUMENT", "CATALOG",
      "CALIB", "CALIBRATION", "GEOMETRY", "BROWSE", "EXTRAS"};

  public static final String[] ILLEGAL_INDEXED_FOLDERS = new String[] {"DOCUMENT", "CATALOG"};
