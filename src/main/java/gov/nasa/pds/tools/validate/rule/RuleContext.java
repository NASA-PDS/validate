...
/**
 * Implements a type-safe context for using validation rules in commands and
 * chains.
 */
public class RuleContext extends ContextBase {
    ...
    /**
     * The key used to retrieve the top-level validator for getting singleton
     * utilities.
     */
    public static final String LOCATION_VALIDATOR_KEY = "validation.location-validator";

    /**
     * The key used to indicate that declared schema and Schematron files in a
     * label should be validated before the label is validate.
     */
    ...
    /**
     * The key used to retrieve the current validation target from the execution
     * context.
     */
    public static final String TARGET_KEY = "validation.target";
    /**
     * The key used to retrieve the definition listener from the execution
     * context.
     */
    ...
    /**
     * The key used to retrieve a hash map containing the checksum values from a
     * given checksum manifest.
     */
    ...
    /**
     * The key used to indicate how many lines or records to skip during content
     * validation.
     */
    public static final String SPOT_CHECK_DATA_KEY = "validate.spot-check";

    /**
     * Key used to tell the tool to allow unlabeled files in a bundle or
     * collection.
     */
    ...
    public static final String VALID_CONTEXT_KEY = "validate.valid-context";
    ...
    /**
     * Gets the top-level validator for getting singleton utilities, such as the
     * label validator.
     * 
    ...
    /**
     * Sets whether to force schema and Schematron validation defined in a
     * label.
     * 
     * @param force
     *            true, if declared schema and Schematron files should be
     *            validated
     */
    ...
    public boolean getValidContext() {
        return getContextValue(VALID_CONTEXT_KEY, Boolean.class);
    }

    public void setValidContext(boolean flag) {
        putContextValue(VALID_CONTEXT_KEY, flag);
    }
}
