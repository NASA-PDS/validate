...
public class XMLCatalog extends Catalog {
   ...
   *
   * <p>
   * The constructor interrogates the relevant system properties using the default (static)
   ...
   *
   * <p>
   * The constructor interrogates the relevant system properties using the specified Catalog Manager
   ...
   */
  /*
   * public void setupReaders() { SAXParserFactory spf = SAXParserFactory.newInstance();
   ...
   * 
   * TR9401CatalogReader textReader = new TR9401CatalogReader(); addReader("text/plain",
   * textReader); }
   */
   ...
   *
   * <p>
   * If a SYSTEM entry exists in the catalog file for the system ID specified, return the mapped
   * value.
   * </p>
   *
