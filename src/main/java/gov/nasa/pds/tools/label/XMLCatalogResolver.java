...
/**
 * <p>
 * Adaption of Xerces XMLCatalogResolver to bootstrap in catalog 1.1 support. In addition the
 * resolveIdentifier method differs in that it does not resolve schema includes based on URIs as is
 * the default behavior with the Xerces version.
 * <p>
 *
 * <p>
 * The catalog resolver handles the resolution of external identifiers and URI references through
 * XML catalogs. This component supports XML catalogs defined by the
 * <a href="http://www.oasis-open.org/committees/entity/spec.html"> OASIS XML Catalogs
 ...
 *
 * <p>
 * It is intended that this class may be used standalone to perform catalog resolution outside of a
 * parsing context. It may be shared between several parsers and the application.
 * </p>
 *
 */
public class XMLCatalogResolver extends CachedLSResourceResolver
  ...
  /**
   * <p>
   * Constructs a catalog resolver with the given list of entry files and the preference for whether
   ...
   * the previous list they will be replaced by catalog mappings from the new list the next time the
   * catalog is queried.
   * </p>
   * 
   * @param catalogs an ordered array list of absolute URIs
  ...
  /**
   * <p>
   * Returns the preference for whether system or public matches are preferred. This is used in the
   * absence of any occurrence of the <code>prefer</code> attribute on the <code>catalog</code>
   * entry of a catalog. If this property has not yet been explicitly set its value is
   * <code>true</code>.
   * </p>
   * 
  ...
  /**
   * <p>
   * Returns the preference for whether the literal system identifier should be used when resolving
   * system identifiers when both it and the expanded system identifier are available. If this
   * property has not yet been explicitly set its value is <code>true</code>.
   * </p>
   * 
   * @return the preference for using literal system identifiers for catalog resolution
   * 
   ...
   * 
   * <p>
   * The literal system identifier is the URI as it was provided before absolutization. It may be
   * embedded within an entity. It may be provided externally or it may be the result of
   ...
   * 
   * <p>
   * The expanded system identifier is an absolute URI which is the result of resolving the literal
   * system identifier against a base URI.
   * </p>
   * 
   * @param useLiteralSystemId the preference for using literal system identifiers for catalog
   *        resolution
   */
   ...
   * <code>null</code>. This method returns an input source if an entry was found in the catalog for
   * the given external identifier. It should be overridden if other behaviour is required.
   * </p>
   * 
  ...
  public LSInput resolveResource(String type, String namespaceURI, String publicId, String systemId,
    ...
    if (systemId == null) {
      if (getProblemHandler() != null) {
        getProblemHandler().addProblem(new ValidationProblem(new ProblemDefinition(
            ExceptionType.WARNING, ProblemType.CATALOG_UNRESOLVABLE_RESOURCE,
      ...
      if (getProblemHandler() != null) {
        getProblemHandler()
            .addProblem(new ValidationProblem(new ProblemDefinition(ExceptionType.ERROR,
                ProblemType.CATALOG_UNRESOLVABLE_RESOURCE, io.getMessage()), baseUrl));
      }
    }
  ...
  public LSInput getLSInputFromResolvableResource(String schemaUrl) {
    return super.resolveResource("", "", "", schemaUrl, schemaUrl);
  }

  private String resolveResource(String namespaceURI, String publicId, String systemId,
  ...
  public String resolveSchematron(String systemId) throws IOException {
    String resolvedId = null;
    // URIs specified in the catalog might be referencing the system identifiers
    // so let's use that to do resolution.
    if (systemId != null) {
   ...
   * source if an entry was found in the catalog. It should be overridden if other behaviour is
   * required.
   * </p>
   *
   ...
   * <code>publicid</code> namespace it is converted into a public identifier by URN "unwrapping" as
  ...
  private void parseCatalogs() throws IOException {
    if (fCatalogsList != null) {
      ...
      for (String catalog : fCatalogsList) {
