...
public class FileFinder {
    // Class provide a utility to find a given file (name, and extension) with a starting directory.
    ...
    public static URL findMyFile(String startDirectory, String findFilename, String extension) {
        ...
        File[] matches = dir.listFiles(new FilenameFilter()
        {
          ...
          {
             //System.out.println("ValidationResourceManager:accept:dir,name " + dir + " " + name);
