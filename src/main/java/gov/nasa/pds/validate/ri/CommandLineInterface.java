...
public class CommandLineInterface {
  ...
  public void process(String[] args) throws IOException, ParseException, ParserConfigurationException, SAXException {
    int cylinders = 1;
    ...
    if (-1 < this.total) this.log.info("Completed the reference integrity checks for " + this.total + " products and found " + this.broken + " broken references.");
  }
